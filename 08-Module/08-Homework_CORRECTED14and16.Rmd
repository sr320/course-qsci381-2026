...
## (14) Fill in the table below by calculating the corresponding sample sizes, means and standard deviations of egg length for each host bird species. Round your answers to 2 decimal places (7 pts)
...
data.frame(
  Sample_Sizes = "value here",
  Sample_Means = "value here",
  Sample_SDs = "value here"
)
...
```{r}
data.frame(
Degrees_of_Freedom = c(Between_Species = "value here", Within_Species = "value here", Total = "value here"),
Sum_of_Squares = c(Between_Species = "value here", Within_Species = "value here", Total = "value here"),
Mean_Squares = c(Between_Species = "value here", Within_Species = "value here", Total = "-"), 
F_Statistic = c("value here", "-", "-"),
F_Critical = c("value here", "-", "-"),
F_p_Value = c("value here", "-", "-")
)
```
